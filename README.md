...
---
### 🪑 스터디카페 좌석 예약 플랫폼 (Android App)

- Kotlin 기반으로 개발된 Android 좌석 예약 앱으로, 실시간 좌석 현황 확인 및 모바일 결제 기능 제공
- 점주 전용 계정을 통해 스터디카페 등록, 좌석 배치 커스터마이징, 이용권 설정 등 다양한 관리 기능 제공
- PHP 및 phpMyAdmin 기반의 백엔드와 연동하여 웹과 앱 간 실시간 데이터 동기화 구현
- 사용자와 점주 유형별 UI 분리 및 좌석 드래그 앤 드롭 배치 등 사용자 중심 기능 구현
